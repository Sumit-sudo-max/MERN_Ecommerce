const { generateToken } = require('../Tokens/jwtToken');
const { generateRefreshToken } = require('../Tokens/refreshtoken');
...
const createdUser = asyncHandler(
    async(req, res) => {
...
const forgotPassword = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        await user.save();
        const resetURL = `Hi, Please follow this link to reset Your Password. This link is valid till 10 minutes from now. <a href='http://localhost:4578/api/user/reset-password/${token}'>Click Here</>`;
        const data = {
            to: email,
            text: "Hey User",
